...
echo "  </tr>";
echo "  <tr>";
echo "    <td><input type='submit' class='boton' name='btn_add_rex2' id='btn_add_rex2' value='Agregar mas Resultados' /></td>";
echo "  </tr>";
echo "  <tr>";
echo "    <td>&nbsp;</td>";
echo "  </tr>";
echo "  <tr>";
echo "    <td><input type='submit' class='boton' name='btn_mod_rex2' id='btn_mod_rex2' value='Modificar / Eliminar Resultado' /></td>";
echo "  </tr>";
echo "  <tr>";
echo "    <td>&nbsp;</td>";
echo "  </tr>";
...
//*********************************************************************************	
echo "<meta http-equiv='refresh' content='0;URL=adjunto.php'>";
}
...
echo "        <input type='submit' class='boton' name='btn_del' id='btn_del' value='Eliminar' />";
echo "      </p>";
echo "    </td>";
echo "    <td rowspan='2'>";
echo "      <input type='submit' class='boton' name='btn_mod_ok' id='btn_mod_ok' value='Guardar Modificaciones' />";
echo "    </td>";
echo "  </tr>";
echo "  <tr>";
echo "    <td class='Texto4'>Observación</td>";
