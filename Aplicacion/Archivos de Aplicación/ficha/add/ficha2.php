...
$sql_add_pal_pac = "insert into palpacion_ek values('$id_palpacion','$txt_sensibilidad',$list_temperatura,'$txt_inflamacion')";
mysql_query($sql_add_pal_pac,$link);
$error_pal =mysql_errno();

$sql_add_insp_pac = "insert into inspeccion_ek values('$id_inspeccion','$txt_piel','$txt_volumen','$txt_cicatriz','$txt_deformidad','$txt_observaciones')";
mysql_query($sql_add_insp_pac,$link);
$error_insp =mysql_errno();

$sql_add_e_kine_pac = "update eva_kine set id_pal = '$id_palpacion',id_insp='$id_inspeccion',id_dol='$id_dolor',obs_ingreso_ek='$txt_observaciones_gen' where id_ek = '$id_eva_kine'";
