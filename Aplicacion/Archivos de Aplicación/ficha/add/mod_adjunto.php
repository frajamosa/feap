...
echo "<table border='1'>";
echo "  <tr>";
echo "    <td colspan='4' class='Texto3' 	bgcolor='#CC3333'>AGREGAR / MODIFICAR RESULTADOS";
echo "    </td>";
echo "  </tr>";
echo "  <tr>";
echo "    <td class='Texto3' bgcolor='#638cb5'>EXAMEN</td>";
echo "    <td>&nbsp;</td>";
echo "    <td class='Texto3' bgcolor='#638cb5'>RESULTADO</td>";
echo "    <td>&nbsp;</td>";
echo "  </tr>";
echo "  <tr>";
echo "    <td rowspan='5' valign='top'>";
echo "      <select style=\"width:250px\" name='lst_examen' size='7' id='lst_examen' onclick='this.form.submit()'>";
...
echo "    <td rowspan='5' valign='top'>";
echo "      <select style=\"width:250px\" name='lst_resultado' size='7' id='lst_resultado'>";
...
echo "  <tr>";
echo "    <td colspan='3' class='Texto3' 	bgcolor='#CC3333'>AGREGAR MAS RESULTADOS";
echo "    </td>";
echo "  </tr>";
echo "  <tr>";
...
echo "    <td>";
echo "      <textarea name='txt_obs2' cols='50' rows='5' class='Texto2' id='txt_obs2'></textarea>";
echo "    </td>";
echo "  </tr><tr>";
echo "    <td>";
echo "        <input type='submit' class='boton' name='btn_add_rex3' id='btn_add_rex3' value='Agregar Resultado' />";
echo "    </td>";
echo "</tr></table></td>";
}
...
echo "<td><table border='1'>";
echo "  <tr>";
echo "    <td colspan='3' class='Texto3' 	bgcolor='#CC3333'>MODIFICAR RESULTADO";
echo "    </td>";
echo "  </tr>";
echo "  <tr>";
...
echo "    <td>";
 ...
 echo "        <input type='submit' class='boton' name='btn_ver' id='btn_ver' value='Ver' />";
 echo "        <input type='submit' class='boton' name='btn_mod' id='btn_mod' value='Cambiar' />";
 echo "        <br><input type='submit' class='boton' name='btn_del' id='btn_del' value='Eliminar' />";
 echo "      </p>";
echo "    </td>";
...
echo "    <td class='Texto4'>Observación</td>";
echo "    <td>";
echo "      <textarea name='txt_obs3' cols='50' rows='4' class='Texto2' id='txt_obs3'>$obs_fichero</textarea>";
echo "    </td>";
echo "  </tr><tr>";
echo "    <td>";
echo "         <input type='submit' class='boton2' name='btn_mod_ok' id='btn_mod_ok' value='Guardar Modificaciones' />";
...
echo "</tr></table></td>";
 echo "  </tr><tr>";
 echo "    <td><input type='submit' class='boton2' name='btn_add_rex2' id='btn_add_rex2' value='Agregar mas Resultados' /></td>";
 echo "  </tr><tr>";
 echo "    <td><input type='submit' class='boton2' name='btn_mod_rex2' id='btn_mod_rex2' value='Modificar / Eliminar Resultado' /></td>";
 echo "  </tr></table>";
 if ($btn_mod or $btn_up or $btn_mod_ok)
 {
 echo "<table border='1' align='right'>";
echo "  <tr 	bgcolor='#CC3333'>";
echo "    <td class='Texto3'>Seleccione Archivo</td>";
echo "    <td>";
echo "      <input type='file' name='file_adjunto2'/>";
echo "        <input type='submit' class='boton' name='btn_up' value='Actualizar Archivo' />";
echo "    </td>";
echo "  </tr>";
echo "</table>";
}
