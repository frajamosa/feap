...
echo "  <tr>";
echo "    <td colspan='2'>";
echo "      <p class='Texto'>Ficha Paciente No.".$id_ficha."</p>";
...
// $sql_info_ana_act="select * from ana_actual where id_ana_act = '$id_ana_act'";
...
//-------------------------------------------------------------------------------FIN-BUSCA CAMPOS DE TEXTO----
	...
	$sql_info_ficha7="select * from ana_actual where id_ana_act = '$id_ana_act'";
	$r_info_ana_act = mysql_query($sql_info_ficha7,$link);
	$info_ana_act = mysql_fetch_array ($r_info_ana_act);

// echo $sql_info_ficha7."<br>";
...
if($btn_aa_ciru)
{
$sql_add_aa_ciru_pac = "insert into aa_cirugia values('$id_ana_act','$tipo_aa_ciru')";
...
if($btn_del_aa_ciru)
{
$sql_del_aa_ciru_pac = "delete from aa_cirugia where id_cirugia = (select id_cirugia from tipo_cirugia where desc_cirugia = '$c_aa[0]') and id_ana_act = $id_ana_act";
mysql_query($sql_del_aa_ciru_pac,$link);	
}
//// echo $sql_del_aa_ciru_pac."<br>";
//**********************************************************************************************
//******************************************************************************Lista cirugia Pac
$sql_aa_ciru_pac = "select desc_cirugia from aa_cirugia, tipo_cirugia where id_ana_act = '$id_ana_act' and tipo_cirugia.id_cirugia = aa_cirugia.id_cirugia";
...
if($btn_aa_prot)
{
$sql_add_aa_prot_pac = "insert into aa_protesis values('$tipo_aa_prot','$id_ana_act')";
...
if($btn_del_aa_prot)
{
$sql_del_aa_prot_pac = "delete from aa_protesis where id_protesis = (select id_protesis from tipo_protesis where desc_protesis = '$p_aa[0]') and id_ana_act = $id_ana_act";
mysql_query($sql_del_aa_prot_pac,$link);	
}
//// echo $sql_del_aa_prot_pac."<br>";
//**********************************************************************************************
//******************************************************************************Lista protesis Pac
$sql_aa_prot_pac = "select desc_protesis from aa_protesis, tipo_protesis where id_ana_act = '$id_ana_act' and tipo_protesis.id_protesis = aa_protesis.id_protesis";
...
$sql_add_ex_pac = "insert into aa_examen values('$id_aa_ex','$id_ana_act','$tipo_examen')";
...
//******************************************************************************Lista Examen
$sql_aa_ex_pac = "select desc_examen, aa_examen.id_aa_examen from aa_examen, tipo_examen where id_ana_act = '$id_ana_act' and tipo_examen.id_examen = aa_examen.id_examen order by tipo_examen.id_examen and aa_examen.id_aa_examen ='$id_aa_ex' ";
