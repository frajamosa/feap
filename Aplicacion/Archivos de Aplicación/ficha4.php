...
$sql_add_artic_pac = "insert into rng_articular values('$id_r_artic','$list_tipo_articulacion','$txt_movimiento','$txt_rango','$txt_endfeel')";
...
echo "  <table border='0'>";
echo "      <tr>";
echo "        <td colspan='7' class='Texto3'>RANGO ARTICULAR";
echo "        <hr /></td>";
echo "      </tr>";
echo "      <tr>";
echo "        <td rowspan='4' valign='top' class='Texto3'>Rango Articular</td>";
echo "        <td rowspan='5'>";
echo "          <select name='list_rng_art' size='7' class='Texto2' id='list_rng_art'>";
...
echo "      </tr>";
echo "      <tr>";
echo "        <td class='Texto3'>Tipo Articulación:</td>";
...
echo "        </td>";
echo "        <td>&nbsp;</td>";
echo "        <td class='Texto3'>Agregar Rango Articular:</td>";
echo "        <td>";
...
echo "  <table border='0'>";
echo "      <tr>";
echo "        <td colspan='7' class='Texto3'>ACORTAMIENTO MUSCULAR";
echo "        <hr /></td>";
echo "      </tr>";
echo "      <tr>";
echo "        <td rowspan='4' valign='top' class='Texto3'>Acortamiento Muscular:</td>";
echo "        <td rowspan='4'>";
echo "          <select name='list_aco_musc' size='7' class='Texto2' id='list_aco_musc'>";
...
echo "      </tr>";
echo "      <tr>";
echo "        <td class='Texto3'>Musculo:</td>";
echo "        <td class='Texto2'>";
...
echo "        </td>";
echo "        <td>&nbsp;</td>";
echo "        <td class='Texto3'>Agregar A. Muscular:</td>";
echo "        <td>";
...
echo "  <table border='0'>";
echo "          <tr>";
echo "            <td colspan='5' class='Texto3'>FUERZA MUSCULAR";
echo "            <hr /></td>";
echo "          </tr>";
echo "          <tr>";
echo "            <td class='Texto3'>Movimiento Muscular:</td>";
echo "            <td class='Texto2'>";
echo "              <input type='text' name='txt_mov_musc' id='txt_mov_musc' value='$txt_mov_musc'/>";
echo "            </td>";
echo "            <td class='Texto2'>&nbsp;</td>";
echo "            <td class='Texto3'>Agregar Fza. Muscular:</td>";
echo "            <td>";
