...
echo "      </tr>";
echo "      <tr>";
echo "        <td colspan='6' class='Texto3'>MIOTOMA";
echo "          <hr /></td>";
echo "        <td class='Texto3'>&nbsp;</td>";
echo "      </tr>";
echo "      <tr>";
echo "        <td rowspan='3' valign='top' class='Texto3'>Miotomas:</td>";
echo "        <td rowspan='3'><select name='list_mio' size='7' class='Texto2' id='list_mio'>";
...
echo "        <td class='Texto3'>Tipo Miotoma:</td>";
echo "        <td class='Texto2'><select name='list_tipo_miotoma' id='list_tipo_miotoma'>";
						if($btn_mod_mio)
						{
...
echo "        <td>&nbsp;</td>";
echo "        <td class='Texto3'>Agregar Miotoma:</td>";
...
echo "        <td colspan='6' class='Texto3'>DERMATOMA";
echo "          <hr /></td>";
echo "        <td class='Texto3'>&nbsp;</td>";
echo "      </tr>";
echo "      <tr>";
echo "        <td rowspan='3' valign='top' class='Texto3'>Dermatomas</td>";
echo "        <td rowspan='3'><select name='list_dermatoma' size='7' class='Texto2' id='list_dermatoma'>";
...
echo "        <td colspan='6' class='Texto3'>REFLEJO";
echo "          <hr /></td>";
echo "        <td class='Texto3'>&nbsp;</td>";
echo "      </tr>";
echo "      <tr>";
...
echo "          <select name='list_reflejo' size='7' class='Texto2' id='list_reflejo'>";
...
echo "    <table border='0'>";
echo "      <tr>";
echo "        <td colspan='7'><span class='Texto3'>PRUEBAS FUNCIONALES<hr></span></td>";
echo "      </tr>";
echo "      <tr>";
echo "        <td rowspan='3' valign='top' class='Texto3'>Pruebas Funcionales</td>";
echo "        <td rowspan='3' class='Texto2'>";
echo "          <select name='list_p_func' size='7' id='list_p_func'>";
...
echo "          </select>";
echo "        </td>";
echo "        <td><span class='Texto3'>Tipo Prueba:</span></td>";
echo "        <td class='Texto2'>";
...
echo "        </td>";
echo "        <td>&nbsp;</td>";
echo "        <td><span class='Texto3'>Agregar Prueba</span></td>";
echo "        <td>";
echo "          <span class='Texto3'>";
