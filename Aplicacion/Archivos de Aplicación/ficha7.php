...
echo "          <p class='Texto3'>Cirugias:</p></td>";
echo "          <td td valign='top' width='22%'>";
echo "			<select name='list_aa_ciru_pac' class='Texto2' id='list_aa_ciru_pac' multiple='multiple' size='7'>";	
...
echo "            </select>";
echo "    		  <input type='submit' class='boton' name='btn_aa_ciru' id='btn_aa_ciru' value='Agregar Cirugia'/>";
echo "			  <br><span class='Texto3'>Eliminar Cirugia: </span>";
echo "			  <input type='submit' class='boton' name='btn_del_aa_ciru' id='btn_del_aa_ciru' value='Eliminar Cirugia' />";
echo "        </td>";
echo "     </tr>";
...
echo "	<table width='100%' border='0'>";
echo "      <tr>";
echo "        <td colspan='3'><span class='Texto3'>PROTESIS";
echo "        </span><hr /></td>";
...
echo "        <td valign='top' width='15%'>";
echo "          <p class='Texto3'>Protesis:</p></td>";
echo "          <td td valign='top' width='22%'>";
echo "			<select name='list_aa_prot_pac' class='Texto2' id='list_aa_prot_pac' multiple='multiple' size='7'>";	
...
echo "            </select>";
echo "    		  <input type='submit' class='boton' name='btn_aa_prot' id='btn_aa_prot' value='Agregar Protesis'/>";
echo "			  <br><span class='Texto3'>Eliminar Protesis: </span>";
echo "			  <input type='submit' class='boton' name='btn_del_aa_prot' id='btn_del_aa_prot' value='Eliminar Protesis' />";
echo "        </td>";
echo "     </tr>";
...
echo " <table width='100%' border='1'>";
echo "      <tr>";
echo "        <td colspan='5'><span class='Texto3'>EXAMENES";
echo "        </span><hr /></td>";
echo "      </tr>";
echo "      <tr>";
	echo "        <td width='15%' rowspan='3' valign='top' class='Texto3'>Ex·menes:</td>";
	echo "        <td width='22%' rowspan='3'><select name='list_examenes' size='5' class='Texto2' id='list_examenes'>";
							while ($info_aa_exam = mysql_fetch_array($r_aa_ex_pac))
							{
								echo "<option value='$info_aa_exam[1]'>$info_aa_exam[0]</option> ";	
							}
	echo "        </select></td>";
	echo "        <td colspan='3' class='Texto3'>";
	echo "          <span class='Texto3'>$txt_nuevo_examen<hr></span>";
	echo "		  </td>";
echo "      </tr>";
echo "      <tr>";
	echo "        <td class='Texto3' valign='middle'>Tipo de Examen:</td>";
	echo "        <td valign='middle' width='22%' >";
...
echo "      <tr>";
	...
	echo "        </td>";
	echo "        <td valign='middle'><input type='submit' class='boton' name='btn_add_rex'  value='Agregar / Modificar otros Resultados' onclick='window.open(\"mod_adjunto.php\",\"_blank\")'/></td>";
...
echo "      <tr>";
	...
	echo "        <td colspan='2'><textarea name='txt_ex_obs' id='txt_ex_obs' cols='80' rows='3'>$info_rex_obs</textarea></td>";
echo "      </tr>";
echo "    </table>";
