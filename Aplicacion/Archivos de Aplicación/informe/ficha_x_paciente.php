...
<?php
echo "<table width='100%' class='Texto1' ><tr><td >BUSCAR - ELIMINAR POR PACIENTE</td></tr></table>";
...
echo "    </td>";
echo "    <td>";
echo "      <input type='submit' class='boton2' name='btn_busca_x_paciente' id='btn_busca_x_paciente' value='BUSCAR POR PACIENTE' />";
echo "    </td>";
echo "  </tr>";
echo "  <tr>";
...
echo "    </td>";
echo "    <td>";
echo "      <input type='submit' class='boton2' name='btn_busca_x_fecha' id='btn_busca_x_fecha' value='BUSCAR POR FECHA' />";
echo "    </td>";
echo "  </tr>";
echo "</table>";
...
if ($btn_busca_x_paciente or $_SESSION['busca_ficha_pac'] and !$btn_busca_x_fecha)
{
		...
		echo "  <tr>";
		echo "    <td colspan='4' class='Texto1'>PACIENTE";
		echo "    <hr /></td>";
		echo "  </tr>";
...
if ($btn_busca_x_fecha and !$btn_busca_x_paciente)
{
		...
		echo "<table width='100%' border='0'>";
		echo "  <tr>";
		echo "    <td colspan='3' class='Texto1'>FECHA";
		echo "    <hr /></td>";
		echo "  </tr>";
		echo "  <tr class='Texto7'>";
		echo "    <td>A�O</td>";
...
if ($btn_busca_x_paciente or $btn_busca_x_fecha or $btn_del or $btn_kine_ord or $btn_int_ord or $btn_fec_ord or $btn_fec_ord2)
{
	...
	$_SESSION['busca_ficha_pac'] = $rut_pac;
	$sql_ficha = "select * from ficha where rut_pac = '$rut_pac' $sort";
