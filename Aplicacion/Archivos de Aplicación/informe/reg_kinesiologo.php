...
echo "<form action='$PHP_SELF' method='post'>";
		...
		$titulo = "Registro de Kinsiologos";
		$boton = "Kinesiologo";		
		//******************************************************************************Busca Kinesiologo
		$sql_kinesiologo = "select * from kinesiologo where vigencia_k = '1' order by apellido_k ";
...
if($btn_mod)
{
			...
			echo "	<meta http-equiv='refresh' content='0;URL=../kinesiologo/mod_kine.php'>";
...
echo "";
echo "  <br />";
echo "  <input type='submit' class='boton' name='btn_imprime' id='btn_imprime' value='Imprimir Informe' onclick='window.open(\"reg_kinesiologo2.php\",\"_blank\")'/>";
echo "";
echo "<p>&nbsp;</p>";
echo "</body>";
echo "</form>";
