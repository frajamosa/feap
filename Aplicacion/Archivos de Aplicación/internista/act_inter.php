...
if($btn_guardar and (rutOK($txt_rut2))==True)//Modifica**************************
{
	...
	//interno*********************
	$sql_actualiza = "update interno set rut_int='$txt_rut2',nombre_int='$txt_nombre',apellido_int='$txt_apellido',telefono_int='$txt_telefono', correo_int ='$txt_mail', vigencia_int = '1' where rut_int = '$id_inter'";
...
if (rutOK($txt_rut2)==True)
{
	...
	{
	case 0:
	echo "	<script language='javascript'>alert('Interno Activado Exitosamente');</script>";
 	$txt_rut2= "";
 	$txt_apellido 	= "";
 	$txt_nombre = "";
 	$txt_telefono="";
...
//*****************************************************************************
	...
	echo "<p class='Texto3'><span class='Texto'>ActivaciÃ³n de interno</span><hr></p>";

  
//Consulta de internos
$sql_interno = "select * from interno  where vigencia_int = '0'";
...
echo " <input type='text' name='txt_nombre' value='$txt_nombre' readonly='readonly'/>";
...
echo " <input type='text' name='txt_apellido' value='$txt_apellido' readonly='readonly'>";
echo "  <span class='textfieldRequiredMsg'>*Campo Obligatorio*</span></span>";
echo "      </span></td>";
echo "    </tr>";
...
echo " <input type='text' name='txt_rut2'  maxlength='10' value='$txt_rut2' readonly='readonly'>";
echo "  <span class='textfieldRequiredMsg'>*Campo Obligatorio*</span></span>";
echo "      </span></td>";
...
echo " <input type='text' name='txt_telefono' value='$txt_telefono' readonly='readonly'>";
echo "  <span class='textfieldRequiredMsg'>*Campo Obligatorio*</span></span>";
echo "      </span></td>";
echo "    </tr>";
...
echo " <input type='text' name='txt_mail' value='$txt_mail' readonly='readonly'>";
echo "  <span class='textfieldRequiredMsg'>*Campo Obligatorio*</span></span>";
echo "      </span></td>";
echo "    </tr>";
...
echo "<br>";
	...
	echo "    <input type='submit' class='boton' name='btn_guardar' id='btn_guardar' value='Activar' />";
