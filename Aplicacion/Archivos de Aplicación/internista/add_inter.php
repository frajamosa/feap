...
if($btn_guardar and (rutOK($txt_rut2))==True) //Agrega**************************
{
	...
	//Registra interno*******************
	$sql_insertar = "insert into interno values ('$txt_rut2','$txt_nombre','$txt_apellido','$txt_telefono','$txt_mail','1')";
...
//	echo $error;
	...
	{
	case 0:
	echo "	<script language='javascript'>alert('Interno Registrado Exitosamente');</script>";
 	$txt_rut2= "";
 	$txt_apellido 	= "";
 	$txt_nombre = "";
 	$txt_telefono="";
...
//*****************************************************************************
	...
	echo "<p class='Texto3'><span class='Texto'>Registro de Nuevo interno</span><hr></p>";
