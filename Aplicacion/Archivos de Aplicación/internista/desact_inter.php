...
if($btn_guardar and (rutOK($txt_rut2))==True)//Modifica**************************
{
	...
	//interno*********************
	$sql_actualiza = "update interno set rut_int='$txt_rut2',nombre_int='$txt_nombre',apellido_int='$txt_apellido',telefono_int='$txt_telefono', correo_int ='$txt_mail', vigencia_int = '0' where rut_int = '$id_inter'";
...
if (rutOK($txt_rut2)==True)
{
	...
	{
	case 0:
	echo "	<script language='javascript'>alert('Interno Desctivado Exitosamente');</script>";
 	$txt_rut2= "";
 	$txt_apellido 	= "";
 	$txt_nombre = "";
 	$txt_telefono="";
...
//*****************************************************************************
	...
	echo "<p class='Texto3'><span class='Texto'>DesctivaciÃ³n de Interno</span><hr></p>";
...
echo "<br>";
	...
	echo "    <input type='submit' class='boton' name='btn_guardar' id='btn_guardar' value='Desctivar' />";
