...
if($btn_guardar and (rutOK($txt_rut))==True)//Modifica**************************
{
	...
	//kinesiologo*********************
	$sql_actualiza = "update kinesiologo set rut_k='$txt_rut',nombre_k='$txt_nombre',apellido_k='$txt_apellido',telefono_k='$txt_telefono', correo_k = '$txt_mail', vigencia_k = '1' where rut_k = '$id_kine'";
...
//	echo $error;
	...
	{
	case 0:
	echo "	<script language='javascript'>alert('Kinesiologo Activado Exitosamente');</script>";
 	$txt_rut= "";
 	$txt_apellido 	= "";
 	$txt_nombre = "";
 	$txt_telefono="";
...
$sql_kinesiologo = "select * from kinesiologo where vigencia_k = '0'";
