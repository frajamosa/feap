...
if($btn_guardar and (rutOK($txt_rut))==True)//Modifica**************************
{
	...
	//kinesiologo*********************
	$sql_actualiza = "update kinesiologo set rut_k='$txt_rut',nombre_k='$txt_nombre',apellido_k='$txt_apellido',telefono_k='$txt_telefono', correo_k = '$txt_mail', vigencia_k = '0' where rut_k = '$id_kine'";
...
//	echo $error;
	...
	{
	case 0:
	echo "	<script language='javascript'>alert('Kinesiologo Desctivado Exitosamente');</script>";
 	$txt_rut= "";
 	$txt_apellido 	= "";
 	$txt_nombre = "";
 	$txt_telefono="";
...
echo "<p class='Texto3'><span class='Texto'>DesactivaciÃ³n de Kinesiologo</span><hr></p>";
...
echo " <input type='text' name='txt_rut' maxlength='10' value='$txt_rut' readonly='readonly'>";
echo "  <span class='textfieldRequiredMsg'>*Campo Obligatorio*</span></span>";
echo "      </span></td>";
...
echo "<br>";
	...
	echo "    <input type='submit' class='boton' name='btn_guardar' id='btn_guardar' value='Desactivar' />";
