...
if($btn_guardar and rutOK($txt_rut)==True)//Modifica**************************
{
	...
	//paciente*********************
	$sql_actualiza = "update paciente set alta_pac = '1' where rut_pac = '$id_pac'";
...
if (rutOK($txt_rut)==True)
{
	...
	{
	case 0:
	echo "	<script language='javascript'>alert('Paciente dado de Alta Exitosamente');</script>";
...
//*****************************************************************************
	...
	echo "<p class='Texto3'><span class='Texto'>Alta de Paciente</span><hr></p>";
...
echo "<br>";
	...
	echo "    <input type='submit' class='boton' name='btn_guardar' id='btn_guardar' value='Dar de Alta' />";
